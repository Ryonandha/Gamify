...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.png" alt="RYONANDHA" width="400" height="300">
        <p><strong>RYONANDHA MITCHELL</strong></p>
        <p>202201009</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.png" alt="EVAN" width="400" height="300">
        <p><strong>EVAN FARREL</strong></p>
        <p>202201007</p>
      </div>
    </div>
